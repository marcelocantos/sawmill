...
go/
  ...
  adapters/         — Language adapters (Python, Rust, TS, JS, Go, C, C++, Java, C#, Ruby, PHP, Kotlin, Swift, Lua, Protobuf, Zig, Bash, SQL)
...
tapper/
  install.rb        — formula install stanza (tapper input)
  formula_includes.rb — formula service block (tapper input)
homebrew/
  io.sawmill.daemon.plist — Standalone launchd plist (unreferenced; its
                      ProgramArguments path predates Apple Silicon)
docs/
